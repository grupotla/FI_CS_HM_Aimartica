...
if (isset($_GET['iReturn']))  {
	$_POST['iReturn'] = base64_decode($_GET['iReturn']);
}

if (isset($_GET['msg_error']))  {
	echo "<font color=red>".$_GET['msg_error']."</font>";
}
...
<form name='fvalida' action="air-operador-agregar-farribo-hwb-<?=$_SESSION['impex']?>.php" method="POST">

	<input type="hidden" name="url_return" value="<?=$_POST['iReturn']?>">
	<input type="hidden" name="url_error" value="<?=$_SERVER['REQUEST_URI']?>">	
...
<table align="center" width="50%">
    ...
    <tr>
        <th>Fecha Arribo:</td>
        <td><input type="text" id="fecha1" name="arrivaldate" size="22" maxlength="30" onFocus="blur()"><img src="imagenes/calendar.png" id="trigger1"></td>
        <th></td>
        <td></td>
    </tr>
</table>
