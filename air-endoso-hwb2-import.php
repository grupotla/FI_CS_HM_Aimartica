...
<form name='fvalida' action="air-operador-endoso-hwb2-<?=$_SESSION['impex']?>.php" method="POST">
<table align="center" width="50%">
    ...
    <tr>
        <th>Fecha Endoso:</td>
        <td><input type="text" id="fecha1" name="fecha_endoso" size="22" maxlength="30" onFocus="blur()"><img src="imagenes/calendar.png" id="trigger1"></td>
