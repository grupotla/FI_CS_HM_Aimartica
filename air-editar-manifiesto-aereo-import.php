...
$query = mysqli_query($link,"SELECT awbnumber, hawbnumber, conocimiento, ubicacion FROM manifiestos_import WHERE vuelo = '$vuelo' AND import_export = '{$_SESSION['ie']}'");
...
$query2 = mysqli_query($link,"SELECT arrivaldate FROM {$_SESSION['air']} WHERE hawbnumber = '$hawb'");
while ($row2 = mysqli_fetch_array($query2))
{
	$arrivaldate = cambia_a_normal($row2["arrivaldate"]);
}
?>
<?php /* <table width="100%">
...
<form name='fvalida' action="air-operador-editar-manifiesto-aereo-<?=$_SESSION['impex']?>.php" method="POST">
<table align="center" width="50%">
    ...
    <tr>
        <th>Fecha Arribo:</td>
        <td><input type="text" id="fecha1" name="arrivaldate" size="22" maxlength="30" value="<?=$arrivaldate ?>" onFocus="blur()"><img src="imagenes/calendar.png" id="trigger1"></td>
        <th></td>
        <td></td>
    </tr>
</table>
