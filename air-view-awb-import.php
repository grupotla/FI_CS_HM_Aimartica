...
$hay_manifiesto = false;
$sql = "SELECT vuelo FROM manifiestos_import WHERE awbnumber = '$awb' AND import_export = '{$_SESSION['ie']}'";
//echo "$sql<br>";
...
<?php 
if ($hay_manifiesto) {
	echo "<p>Despues de completar datos de Hawb, se pueden guardar estas casillas.</p>";
} else {
	echo "<font color=red>No se ha completado datos de Hawb</font>";
} ?>
