...
if (empty($_POST["piezas"]))
{
	echo"<link rel='stylesheet' href='css/customer.css' media='screen' type='text/css' title='estilo'>
		...
		echo "<div align='center'><br>Debes ingresar una cantidad de piezas.<br>
			<br><a href='air-clonar-hwb2-{$_SESSION['impex']}.php?awbnumber=$awb'><button><p>Regresar</p></button></a></div><br>";
		exit;
}
...
$values = "'".$_POST["awbnumber"]."', '".$_POST["hawbnumber"]."', '".$_POST["puerto_origen"]."', '".$_POST["puerto_destino"]."', '".$_POST["bultos"]."', '".$_POST["almacen"]."', '".$_POST["vuelo"]."', '".$_POST["conocimiento"]."', '".$_POST["ubicacion"]."', '".cambia_a_mysql($_POST["fecha_arribo_tica"])."', '".$_POST["piezas"]."', '".$_POST["peso"]."', '$user', 1, 0, 0, '{$_SESSION['ie']}'";
...
header("Location: air-view-hwb-parcializados-{$_SESSION['impex']}.php?awbnumber=$air");
?>